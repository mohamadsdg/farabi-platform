/**
 * @version: 1.0.0 Custom persian bootstrap datepicker
 */

(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['moment-jalaali', 'jquery', 'exports'], function (momentjs, $, exports) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.language = 'en'; // extend
        this.ranges = {};
        this.jalaali = false; // extend
        this.opens = 'right'; // extend
                ...
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                        ...
                        '<div class="calendar-time">' +
                            '<div></div>' +
                            '<i class="fa fa-clock-o glyphicon glyphdrp-time"> </i>' +
                        '</div>' +
                    '</div>' +
        ...
        if (options.jalaali) this.locale = locale_fa; // extend
        ...
        if (this.singleDatePicker) {
            ...
            if (!this.timePicker) {
                this.container.find('.ranges .applyBtn ').hide();
                this.container.find('.ranges .cancelBtn ').hide();
            }
        }
        ...
        this.container.find('.switchBtn').html(this.locale.switchLabel);
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'button.switchBtn', $.proxy(this.clickSwitch, this))
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><span>➝</span></th>'; //extend
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><span> ➝ </span></th>'; //extend
            } else {
                html += '<th></th>';
            }
            html += '</tr>';
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (!disabled)
                        cname += 'available';
                    html += '<td class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-containers="body" data-placement="top" data-title="' + 'r' + row + 'c' + col + '">' +
        ...
        clickSwitch:function(e){
            // console.log('change calendar click');
            this.element.trigger('switch.daterangepicker', this);
        },
